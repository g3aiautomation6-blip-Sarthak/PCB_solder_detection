...
def evaluate():
    ...
    checkpoint_path = "models/baseline_A_two_class/best.pth"
    ...
    with open("data/coco_dataset/annotations/instances_val2017.json") as f:
        coco = json.load(f)
    ...
    for img_id, img_info in img_dict.items():
        ...
        if gt_count not in images_to_viz:
            ...
            out_name = f"viz_A_{gt_count}_points.jpg"
